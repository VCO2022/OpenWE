var _root_list2, _map2, day, month, year, date, hour, minute, time, _root_list3, _map3, _root_list6, _map6, _root_list, _map, _root_list4, _map4, _root_list5, _map5, _root_list7, _map7, _root_list8, _map8, _wrapper, _root_list_sub1, sub1, mundo, _string, _string_code, _hash;
...
{
    if (object_index != obj_tuberia_res && object_index != obj_cannon_res && object_index != obj_cannon_red_res && object_index != obj_semisolid_platform1 && object_index != obj_mushroom_platform_res && object_index != obj_vine_res && object_index != obj_pokey_res && object_index != obj_bullebill_base_red_res && object_index != obj_bullebill_base_res && object_index != obj_platform_res && object_index != obj_platform_blue_res && object_index != obj_puente_res && object_index != obj_door_res && object_index != obj_door_exit_res && object_index != obj_door_switch_res && object_index != obj_door_switch_exit_res && object_index != obj_door_lock_res && object_index != obj_door_lock_exit_res && object_index != obj_firebar_res && object_index != obj_cinta_res && object_index != obj_cinta_on_res && object_index != obj_ground && object_index != obj_ground_slope)
    {
        _map = ds_map_create()
...
with (obj_parent_resource)
{
    if (object_index == obj_semisolid_platform1 || object_index == obj_mushroom_platform_res || object_index == obj_vine_res || object_index == obj_platform_res || object_index == obj_platform_blue_res || object_index == obj_puente_res || object_index == obj_pokey_res || object_index == obj_bullebill_base_red_res || object_index == obj_bullebill_base_res || object_index == obj_firebar_res || object_index == obj_cinta_res || object_index == obj_cinta_on_res)
    {
        _map7 = ds_map_create()
...
_string_code = base64_encode(_string)
_hash = sha1_string_utf8_hmac(global.drez, _string_code)
_string_code += _hash
...
with (obj_load_image)
    instance_destroy()
scr_toast(0, "Se han guardado los cambios")
