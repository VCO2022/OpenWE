...
{
    if (object_index != obj_tuberia_res && object_index != obj_cannon_res && object_index != obj_cannon_red_res && object_index != obj_semisolid_platform1 && object_index != obj_mushroom_platform_res && object_index != obj_vine_res && object_index != obj_pokey_res && object_index != obj_bullebill_base_red_res && object_index != obj_bullebill_base_res && object_index != obj_platform_res && object_index != obj_platform_blue_res && object_index != obj_puente_res && object_index != obj_door_res && object_index != obj_door_exit_res && object_index != obj_door_switch_res && object_index != obj_door_switch_exit_res && object_index != obj_door_lock_res && object_index != obj_door_lock_exit_res && object_index != obj_firebar_res && object_index != obj_cinta_res && object_index != obj_cinta_on_res && object_index != obj_ground)
    {
        _map = ds_map_create()
