if ((!audio_is_playing(snd_SMB_course_clear_castle)) && (!audio_is_playing(snd_SMB3_course_clear_castle)) && (!audio_is_playing(bgm_smwclear_castle)) && (!audio_is_playing(snd_NSMBU_clear_castle)))
{
