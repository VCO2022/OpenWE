...
{
    draw_sprite_ext(spr_player_lives, global.jugador, (camera_get_view_x(view_get_camera(0)) + 11), (camera_get_view_y(view_get_camera(0)) + 6), 1, 1, 0, c_white, 1)
    draw_text((camera_get_view_x(view_get_camera(0)) + 36), (camera_get_view_y(view_get_camera(0)) + 11), string_hash_to_newline(string_add_zeros(lives, 3)))
