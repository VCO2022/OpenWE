...
if (global.bg_level == "forest" || global.bg_level == "beach")
    draw_sprite(spr_minitabs, 1, camera_get_view_x(view_get_camera(0)), camera_get_view_y(view_get_camera(0)))
else
    draw_sprite(spr_minitabs, 2, camera_get_view_x(view_get_camera(0)), camera_get_view_y(view_get_camera(0)))
