...
if (sprite_index != spr_SMB_charginchuck_damage && sprite_index != spr_SMB3_charginchuck_damage && sprite_index != spr_charginchuck_damage && sprite_index != spr_NSMBU_charginchuck_hurt)
{
    if (hp > 1)
    {
        if (firehp <= 1)
