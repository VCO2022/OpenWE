if (hold == 2)
{
    ...
    if instance_exists(obj_mario)
    {
        ...
        if (keyboard_check_pressed(global.saltar) && (!keyboard_check_pressed(global.saltar_spin)))
        {
            ...
            alarm[0] = 40
            hold = 0
            var sped_claw = knopen_xspeed[segmenten]
        ...
        var m = obj_mario
        var solidtop = collision_rectangle((m.bbox_left + 4), m.bbox_bottom, (m.bbox_right - 4), (m.bbox_bottom + 1), obj_solidtop, 0, 0)
        var solidphy = collision_rectangle((m.bbox_left + 4), m.bbox_bottom, (m.bbox_right - 4), (m.bbox_bottom + 1), obj_physicssolid, 0, 0)
        var solidbullet = collision_rectangle((m.bbox_left + 4), m.bbox_bottom, (m.bbox_right - 4), (m.bbox_bottom + 1), obj_bullebill_base, 0, 0)
