...
draw_text((camera_get_view_x(view_get_camera(0)) + (camera_get_view_width(view_get_camera(0)) / 2)), (y + 36), string_hash_to_newline("Para poder publicar el nivel, debes comprobar#que puedes superarlo. ¿Quieres intentarlo ahora?"))
