if (global.apariencia == 0)
{
    if (global.bg_level == "snow" && global.modo_noche == 1)
        ...
        sprite_index = spr_SMB_pinchos_dark
    else if (global.bg_level == "Mountain y Volcano") && (global.modo_noche == 0)
...
{
    if (global.bg_level != "Mountain y Volcano") && (global.bg_level == "underground" || global.bg_level == "ghost" || global.modo_noche == 1)
