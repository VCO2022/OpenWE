...
draw_text_color((camera_get_view_x(view_get_camera(0)) + 20), (camera_get_view_y(view_get_camera(0)) + 16), string_hash_to_newline("Guardar Nivel"), c_title, c_title, c_title, c_title, 1)
