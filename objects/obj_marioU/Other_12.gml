...
if (keyboard_check(global.abajo) && global.powerup == -30 && ((helice_fly > 1 && helice_fly != 5) || (helice_fly == 1 && fly_cap > 15)))
{
    ...
    helice_fly = 2
if ((sprite_index == spr_NSMBU_mario_helice_fall || 3337) && image_index > 9 && helice_fly == 2 && (!audio_is_playing(snd_NSMBU_helice_planear)))
...
if (global.powerup == -43 && keyboard_check_pressed(global.saltar_spin) && (!instance_exists(obj_kuribo_drybones)) && disablecontrols == 0 && groundpount == 0 && doublejump == 0 && holding == 0 && inclown == 0 && stompstyle == 0 && airspin == 0 && walljump == 0 && holding != 3 && isduck == 0)
{
    doublejump = 1
