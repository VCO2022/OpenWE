...
switch bg_s
{
    ...
    case "castle":
        ...
        s_block_hidden = 8
        s_puente = 96
		obj_dog.image_index = 2
        break
    case "underwater":
	if (global.apariencia == 3 && global.modo_noche == 0)
        {
            __background_set( e__BG.Index, 0, bg_NSMBU_underwater_0 )
            __background_set( e__BG.Index, 1, bg_NSMBU_underwater_1 )
            __background_set( e__BG.Index, 2, bg_NSMBU_underwater_2 )
            __background_set( e__BG.Index, 3, bg_NSMBU_underwater_3 )
            __background_set( e__BG.Index, 4, bg_NSMBU_underwater_4 )
            __background_set( e__BG.Index, 5, bg_NSMBU_underwater_5 )
			__background_set( e__BG.Index, 6, bg_NSMBU_underwater_6 )
            __background_set( e__BG.Visible, 1, 1 )
            __background_set( e__BG.Visible, 2, 1 )
            __background_set( e__BG.Visible, 3, 1 )
            __background_set( e__BG.Visible, 4, 1 )
	...
	if (global.apariencia == 3)
        {
            ...
            {
                __background_set( e__BG.Index, 0, bg_NSMBU_ghost_night_0 )
                __background_set( e__BG.Index, 1, bg_NSMBU_ghost_night_1 )
            }
            __background_set( e__BG.Visible, 1, 1 )
		}
        else
    ...
    if (global.apariencia == 3)
        {
            if (global.modo_noche == 0)
            {
                ...
                __background_set( e__BG.Index, 6, bg_NSMBU_airship_6 )
                __background_set( e__BG.Visible, 4, 1 )
                __background_set( e__BG.Visible, 5, 1 )
                __background_set( e__BG.Visible, 6, 1 )
            }
            else
            {
                ...
                __background_set( e__BG.Index, 6, bg_NSMBU_airship_night_6 )
            }
            __background_set( e__BG.Visible, 1, 1 )
            __background_set( e__BG.Visible, 2, 1 )
            __background_set( e__BG.Visible, 3, 1 )
    ...
    if (global.apariencia == 3 && global.modo_noche == 0)
        {
            ...
            __background_set( e__BG.Index, 6, bg_NSMBU_forest_7 )
            __background_set( e__BG.Visible, 1, 1 )
            __background_set( e__BG.Visible, 2, 1 )
            __background_set( e__BG.Visible, 3, 1 )
            __background_set( e__BG.Visible, 4, 1 )
    ...
    case "mountain":
		...
		if (global.modo_noche == 1)
			obj_dog.image_index = 13
		else if (global.modo_noche == 0)
			obj_dog.image_index = 12
        break
}
