...
if (global.shadows == 1) and (global.apariencia != 3){
	draw_sprite_ext(spr_firebar_base, global.apariencia, ((x - 8)+3), ((y - 8)+3), image_xscale, image_yscale, image_angle, c_black, global.fade)
}
...
for (i = 0; i < fireballs; i++)
{
	...
	if (global.shadows == 1) and (global.apariencia != 3){
		draw_sprite_ext(spr_firebar, global.apariencia, (x + xExtra + 3), (y + yExtra + 3), 1, 1, spin_angle, c_black, global.fade)
	}
