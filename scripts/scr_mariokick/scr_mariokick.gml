...
else if (global.apariencia == 4)
{
    if (global.jugador == 0)
    {
        ...
        {
            case 0:
                return spr_SMB2_mario_small_kick;
            case 1:
                return spr_SMB2_mario_big_kick;
            case 2:
                return spr_SMB2_mario_fire_kick;
        }
    ...
    else if (global.jugador == 1)
    {
        ...
        {
            case 0:
                return spr_SMB2_luigi_small_kick;
            case 1:
                return spr_SMB2_luigi_big_kick;
            case 2:
                return spr_SMB2_luigi_fire_kick;
        }
    ...
    else if (global.jugador == 2)
    {
        ...
        {
            case 0:
                return spr_SMB2_toad_small_kick;
            case 1:
                return spr_SMB2_toad_big_kick;
            case 2:
                return spr_SMB2_toad_fire_kick;
        }
    ...
    else if (global.jugador == 3)
    {
        ...
        {
            case 0:
                return spr_SMB2_toadette_small_kick;
            case 1:
                return spr_SMB2_toadette_big_kick;
            case 2:
                return spr_SMB2_toadette_fire_kick;
        }
