...
else if (global.apariencia == 4)
{
    ...
    else if (global.jugador == 1)
    {
        ...
        {
            case 0:
                return spr_SMB2_luigi_small_jump;
            case 1:
                return spr_SMB2_luigi_big_jump;
            case 2:
                return spr_SMB2_luigi_fire_jump;
        }
    ...
    else if (global.jugador == 2)
    {
        ...
        {
            case 0:
                return spr_SMB2_toad_small_jump;
            case 1:
                return spr_SMB2_toad_big_jump;
            case 2:
                return spr_SMB2_toad_fire_jump;
        }
    ...
    else if (global.jugador == 3)
    {
        ...
        {
            case 0:
                return spr_SMB2_toadette_small_jump;
            case 1:
                return spr_SMB2_toadette_big_jump;
            case 2:
                return spr_SMB2_toadette_fire_jump;
        }
